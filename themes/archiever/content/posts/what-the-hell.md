...
summary: Bu Rehber sizlere kolaylık sağlaması açısından emek verilip, tecrübeler neticesi ile yazılmıştır. Kafanıza takılan bir çok konuda cevap bulmanıza yardımcı olucaktır.
draft: false
type: post
author: Kaptan
weight: -1
...
- [API](#api)
  ...
  - [Options](#options)
  - [Methods](#methods)
    - [`open({ target?: HTMLElement }): Promise<Zoom>`](#open-target-htmlelement--promisezoom)
    - [`close(): Promise<Zoom>`](#close-promisezoom)
    - [`toggle({ target?: HTMLElement }): Promise<Zoom>`](#toggle-target-htmlelement--promisezoom)
    - [`attach(...selectors: string[] | HTMLElement[] | NodeList[] | Array[]): Zoom`](#attachselectors-string--htmlelement--nodelist--array-zoom)
    - [`detach(...selectors: string[] | HTMLElement[] | NodeList[] | Array[]): Zoom`](#detachselectors-string--htmlelement--nodelist--array-zoom)
    - [`update(options: object): Zoom`](#updateoptions-object-zoom)
    - [`clone(options?: object): Zoom`](#cloneoptions-object-zoom)
    - [`on(type: string, listener: () => void, options?: boolean | AddEventListenerOptions): Zoom`](#ontype-string-listener---void-options-boolean--addeventlisteneroptions-zoom)
    - [`off(type: string, listener: () => void, options?: boolean | AddEventListenerOptions): Zoom`](#offtype-string-listener---void-options-boolean--addeventlisteneroptions-zoom)
    - [`getOptions(): object`](#getoptions-object)
    - [`getImages(): HTMLElement[]`](#getimages-htmlelement)
    - [`getZoomedImage(): HTMLElement`](#getzoomedimage-htmlelement)
